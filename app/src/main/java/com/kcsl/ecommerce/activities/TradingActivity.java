...
import com.kcsl.ecommerce.databinding.ActivityTradingBinding;
...
public class TradingActivity extends AppCompatActivity {
    ...
    ActivityTradingBinding tradingBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tradingBinding = DataBindingUtil. setContentView(this,R.layout.activity_trading);
        productDesignList1 = tradingBinding.productDesignListOne;
        productDesignList2 = tradingBinding.productDesignListTwo;
        productDesignList3 = tradingBinding.productDesignListThree;
        productDesignList4 = tradingBinding.productDesignListFour;
        ...
        tradingBinding.backButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tradingBinding.notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TradingActivity.this,NotificationActivity.class));
            }
        });

        tradingBinding.searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TradingActivity.this,SearchProductActivity.class));
            }
        });

        tradingBinding.searchText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TradingActivity.this,SearchProductActivity.class));
            }
        ...
        tradingBinding.sortByLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TradingActivity.this,SortByActivity.class));
            }
        });

        tradingBinding.filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TradingActivity.this,FilterActivity.class));
            }
        });
