...
import com.kcsl.ecommerce.databinding.ActivityNewUserGiftBinding;

import java.util.ArrayList;

public class NewUserGiftActivity extends AppCompatActivity {

    private int currentApiVersion;
    ActivityNewUserGiftBinding newUserGiftBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUserGiftBinding = DataBindingUtil. setContentView(this,R.layout.activity_new_user_gift);
        productDesignList1 = newUserGiftBinding.productDesignListOne;
        productDesignList2 = newUserGiftBinding.productDesignListTwo;
        productDesignList3 = newUserGiftBinding.productDesignListThree;
        productDesignList4 = newUserGiftBinding.productDesignListFour;
        ...
        newUserGiftBinding.backButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        newUserGiftBinding.notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewUserGiftActivity.this,NotificationActivity.class));
            }
        });

        newUserGiftBinding.searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewUserGiftActivity.this,SearchProductActivity.class));
            }
        });

        newUserGiftBinding.searchText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewUserGiftActivity.this,SearchProductActivity.class));
            }
        ...
        newUserGiftBinding.sortByLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewUserGiftActivity.this,SortByActivity.class));
            }
        });

        newUserGiftBinding.filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(NewUserGiftActivity.this,FilterActivity.class));
            }
        });
