...
import com.kcsl.ecommerce.databinding.ActivityFlashSellBinding;
...
public class FlashSellActivity extends AppCompatActivity {
    ...
    ActivityFlashSellBinding flashSellBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flashSellBinding = DataBindingUtil. setContentView(this,R.layout.activity_flash_sell);
        productDesignList1 = flashSellBinding.productDesignListOne;
        productDesignList2 = flashSellBinding.productDesignListTwo;
        productDesignList3 = flashSellBinding.productDesignListThree;
        productDesignList4 = flashSellBinding.productDesignListFour;
        ...
        flashSellBinding.backButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        flashSellBinding.notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FlashSellActivity.this,NotificationActivity.class));
            }
        });

        flashSellBinding.searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FlashSellActivity.this,SearchProductActivity.class));
            }
        });

        flashSellBinding.searchText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FlashSellActivity.this,SearchProductActivity.class));
            }
        ...
        flashSellBinding.sortByLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              startActivity(new Intent(FlashSellActivity.this,SortByActivity.class));
            }
        });

        flashSellBinding.filter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FlashSellActivity.this,FilterActivity.class));
            }
        });
