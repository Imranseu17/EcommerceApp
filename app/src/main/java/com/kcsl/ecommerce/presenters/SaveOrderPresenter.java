...
import com.kcsl.ecommerce.callbacks.SaveOrderUserView;
...
public class SaveOrderPresenter {
    private SaveOrderUserView mViewInterface;
    private APIClient mApiClient;

    public  SaveOrderPresenter(SaveOrderUserView view) {
    ...
    public void attemptSaveOrder(String token) {
                ...
                .enqueue(new Callback<SaveOrder>() {
                    ...
                    public void onResponse(Call<SaveOrder> call, Response<SaveOrder> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (saveOrder!= null) {
                                mViewInterface.onSuccess(saveOrder, GetCardItemsEnum.GetCardItems_SUCCESS.getCode());
                            } else {
                    ...
                    @Override
                    public void onFailure(Call<SaveOrder> call, Throwable e) {
                        e.printStackTrace();
