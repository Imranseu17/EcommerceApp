...
public class NewProductsPresenter {
    private ProductsUserView mViewInterface;
    private APIClient mApiClient;

    public  NewProductsPresenter (ProductsUserView view) {
    ...
    public void attemptGetNewProducts(int newValue) {

        final Map<String, String> map = new HashMap<>();
        map.put("Accept", "application/json");

        mApiClient.getAPI()
                .getAllNewProducts(map,newValue)
                .enqueue(new Callback<Products>() {
                    ...
                    public void onResponse(Call<Products> call, Response<Products> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (products!= null) {
                                mViewInterface.onNewProductSuccess(products, ProductsEnum.Products_SUCCESS.getCode());
                            } else {
    ...
    public void attemptGetNewProducts(int newValue,int page,int limit) {

        final Map<String, String> map = new HashMap<>();
        map.put("Accept", "application/json");

        mApiClient.getAPI()
                .getAllNewProducts(map,newValue,page,limit)
                .enqueue(new Callback<Products>() {
                    @Override
                    public void onResponse(Call<Products> call, Response<Products> response) {
                        DebugLog.e("CODE: "+response.code());
